...
class CrossUnetAttentionGenerator(nn.Module):
    ...
    def __init__(self, backbone='unet'):
        ...
        self.FFCA0 = FlowFaceCrossAttentionModel(seq_len=16, n_head=2, q_dim=1024, k_dim=1024, kv_dim=1024)
        self.FFCA1 = FlowFaceCrossAttentionModel(seq_len=64, n_head=2, q_dim=1024, k_dim=1024, kv_dim=1024)
        self.FFCA2 = FlowFaceCrossAttentionModel(seq_len=256, n_head=2, q_dim=512, k_dim=512, kv_dim=512)
        self.FFCA3 = FlowFaceCrossAttentionModel(seq_len=1024, n_head=2, q_dim=256, k_dim=256, kv_dim=256)
        self.FFCA4 = FlowFaceCrossAttentionModel(seq_len=4096, n_head=2, q_dim=128, k_dim=128, kv_dim=128)
        self.FFCA5 = FlowFaceCrossAttentionModel(seq_len=16384, n_head=2, q_dim=64, k_dim=64, kv_dim=64)
        self.FFCA6 = FlowFaceCrossAttentionModel(seq_len=65536, n_head=2, q_dim=32, k_dim=32, kv_dim=32)
